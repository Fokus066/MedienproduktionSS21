...
class Environment_Operator(bpy.types.Operator):
    ...
    distance: FloatProperty(name="Distance", description="Area in which Saplings will be created", unit='LENGTH')
    ...
    def execute(self, context):
        ...
        for obj in newobjects:
            ...
            if obj.type == 'CURVE':
                ...
                x = (random.random() * distance) - distance/2 + cursor[0] 
                y = (random.random() * distance) - distance/2 + cursor[1]

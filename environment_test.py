...
class Environment_Operator(bpy.types.Operator):
    ...
    def generate_Streets(self):
        ...
        #C:\Users\Vinzenz\Documents\MedienProd
        base_path = os.getcwd()
        bpy.ops.image.open(filepath="/Users/Vinzenz/Documents/MedienProd/street.png")
    ...
    def generate_houses(self):
        ...
        garage_door_size_y = 5
        garage_door_size_z = 4
        ...
        for i in range(number_houses):
                ...
                bpy.ops.mesh.primitive_cube_add(scale=(0.5, 3, 3),location=(  (-self.meadow_size/2  + (i * 50)) +7.5, -58 , 7))
                side_window_1 = bpy.context.object
                side_window_1.name = "side_window_1"

                bpy.ops.mesh.primitive_cube_add(scale=(0.5, 3, 3),location=(  (-self.meadow_size/2  + (i * 50))+7.5, -48 , 7))
                ...
                bpy.ops.mesh.primitive_cube_add(scale=(0.5, 3, 3),location=(  -self.meadow_size/2  + (i * 50)+4.5, -63, 7))
                ...
                bpy.ops.mesh.primitive_cube_add(scale=(0.5, 3, 3),location=(  -self.meadow_size/2  + (i * 50)+4.5, -63, 14))
                ...
                bpy.ops.mesh.primitive_cube_add(scale=(0.5, 3, 3),location=(  -self.meadow_size/2  + (i * 50)+4.5, -43, 7))
                back_window_1 = bpy.context.object
                back_window_1.rotation_euler = (0 , 0 ,1.5708 )
                back_window_1.name = "back_window_1"

                bpy.ops.mesh.primitive_cube_add(scale=(0.5, 3, 3),location=(  -self.meadow_size/2  + (i * 50)+4.5 -9, -43, 7))
                back_window_2 = bpy.context.object
                back_window_2.rotation_euler = (0 , 0 ,1.5708 )
                back_window_2.name = "back_window_2"

                bpy.ops.mesh.primitive_cube_add(scale=(0.5, 3, 3),location=(  -self.meadow_size/2  + (i * 50)+4.5 , -43, 14))
                back_window_3 = bpy.context.object
                back_window_3.rotation_euler = (0 , 0 ,1.5708 )
                back_window_3.name = "back_window_3"

                bpy.ops.mesh.primitive_cube_add(scale=(0.5, 3, 3),location=(  -self.meadow_size/2  + (i * 50)+4.5-9, -43, 14))
                ...
                frontdoor.data.materials.append(self.add_fence_texture_horizontal())

                bpy.ops.mesh.primitive_cube_add(scale=(house_door_size_x, house_door_size_y, house_door_size_z),location=(  -self.meadow_size/2  + (i * 50), -43, house_door_size_z*0.5))
                door_behind = bpy.context.object
                door_behind.rotation_euler = (0 , 0 ,1.5708 )
                door_behind.data.materials.append(self.add_fence_texture_horizontal())
                ...
                bpy.ops.mesh.primitive_cube_add(scale=(garage_door_size_x , garage_door_size_y , garage_door_size_z ),location=(-self.meadow_size/2 +  (i * 50) -15, -58.9755, (garage_door_size_z*0.5)+0.5))
                garage_door = bpy.context.object
                garage_door.rotation_euler = (0 , 0 ,1.5708 )
                garage_door.data.materials.append(self.add_fence_texture_horizontal())
